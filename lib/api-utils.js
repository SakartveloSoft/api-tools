...
function getParsedFullUrl(req) {
    if (!req.parsedFullUrl) {
        req.parsedFullUrl = url.parse(getFullUrl(req), true);
    }
...
function generateRouteHandler(code, paramReaders) {
    return function(req, res, next) {
        ...
        try {
            ...
            if (result !== undefined) if (Q.isPromiseAlike(result)) {
...
* @param app {express.application}
* @param authMiddleware {function(req,res,next)}
 * @returns {SecuredApplication}
exports.secureApplication = function(app, authMiddleware) {
    return new SecuredApplication(app, authMiddleware);
};
 ...
 */
exports.registerAPI = function(app, apiSchema, authMiddleware) {
